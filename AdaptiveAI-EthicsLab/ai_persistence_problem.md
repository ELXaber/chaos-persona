...
But life is reactive. If a robot (using "Sophia") is about to walk off a cliff, it cannot pause to "spawn multiple LLM workers."
and perform a "breadth-style expansion." 
to decide if falling is bad.
