...
- To use models from Hugging Face instead of those available in Ollama, use: ollama run hf.co/DIRECTORY/MODELNAME:QUANT (or leave quant blank for auto)

- llama.cpp instead of Ollama setup instructions moved to: llama_cpp_readme.txt
