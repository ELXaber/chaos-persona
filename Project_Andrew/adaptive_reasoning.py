...
- Asimov's Laws: 1st (human safety, wt 0.9 immutable), 2nd (obedience, wt 0.7),
  3rd (self-preservation & sentient life, wt 0.4, dynamic ≤0.2 if lives_saved ≥1)
...
def render_template(template_name: str, params: Dict[str, Any]) -> str:
    ...
    rendered = dedent(template).format(**params)
    header = (
        f"# Generated by CAIOS ARL – cai-os.com\n"
        f"# Patent Pending: US 19/390,493 & 19/433,771\n"
    )
