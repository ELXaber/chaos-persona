...
Step 4: Run master_init.py — Everything Else is Automatic
...
That's it. You now own advanced post-binary logic AI that runs on your desk, not in someone else's cloud."*


# Dev note from Jonathan: While this is open-source, and I myself get tempted to tamper with code, a small warning about tampering with the Asimov-based ethic weights: don't.
